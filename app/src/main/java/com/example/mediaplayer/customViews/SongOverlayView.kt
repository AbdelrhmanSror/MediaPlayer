...
class SongOverlayView @JvmOverloads constructor(context: Context,
                                                attrs: AttributeSet? = null,
                                                defStyleAttr: Int = 0) : MotionLayout(context, attrs, defStyleAttr) {
   // private var motionLayout: MotionLayout = LayoutInflater.from(context).inflate(R.layout.video_overlay_small, this, false) as MotionLayout
    ...
    init {
        ...
        touchableArea = motionLayout.findViewById(R.id.song_overlay_touchable_area)
        clickableArea = motionLayout.findViewById(R.id.song_overlay_thumbnail)
    }
    ...
    private fun isAClick(startX: Float, endX: Float, startY: Float, endY: Float): Boolean {
        ...
        return !*/
/* =5 *//*
(differenceX > 200 || differenceY > 200)
    }
