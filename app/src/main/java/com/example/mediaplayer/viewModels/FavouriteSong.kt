...
class FavouriteSongViewModel constructor(application: Application, tracksRepository: TracksRepository) : AndroidViewModel(application) {
    val playLists = tracksRepository.getFavouriteSongs()

}

class FavouriteSongViewModelFactory constructor(private val application: Application)
    ...
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        ...
        if (modelClass.isAssignableFrom(FavouriteSongViewModel::class.java)) {
            return FavouriteSongViewModel(application, tracksRepository!!) as T
